...
- `pdfdancer-client-java` ![Maven](https://img.shields.io/badge/Maven-0.2.6-blue) – JVM SDK exposing fluent selectors,
...
- `pdfdancer-client-python` ![PyPI](https://img.shields.io/badge/PyPI-0.3.8-blue) – Python 3.10+ SDK mirroring the
...
- `pdfdancer-client-typescript` ![npm](https://img.shields.io/badge/npm-2.0.7-blue) – TypeScript SDK for Node.js and
